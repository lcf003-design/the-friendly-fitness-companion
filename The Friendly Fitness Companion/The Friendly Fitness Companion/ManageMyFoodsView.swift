                        ...
                        if !searchText.isEmpty {
                            ...
                            if apiManager.isSearching {
                                ...
                                ForEach(apiManager.searchResults, id: \.self) { result in
                                    Button(action: {
                                        selectedFoodForAction = UnifiedFoodItem(name: result.name, brand: result.brand, calories: result.calories, protein: result.protein, fat: result.fat, carbs: result.carbs, sodium: result.sodium, isVerified: true, servingSize: result.servingSize, grade: result.grade, imageUrl: result.imageUrl)
                                    }) {
